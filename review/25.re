...
packagesを拡張して使う記事は複数あるがリレーションを書いて拡張する方針の物は検索しても見つからなかった。そこでここではAuthを拡張してリレーションを付け加える方法を書く。私はPHPを使い始めて間もないので、この方針が正しいのか判別がつかない。Advent Calendarに投稿することでよりよい方法についてご助言をいただけたらと考えています。
...
学生です！Web ServiceをFuelPHPで作りました。Advent Calendarに記事を書いて宣伝しようと考えてました。が、知命的なバグが出たので間に合わず…
